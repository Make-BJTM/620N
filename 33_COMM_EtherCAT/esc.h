...
#define ESC_SLAVE_ALIAS_OFFSET                	0x0012 
...
#define ESC_PROT0_RX_ERR						0x0300
#define ESC_PROT1_RX_ERR						0x0302
#define ESC_FORWARD_RX_ERR						0x0308
#define ESC_HANDLE_ERR							0x030c
#define ESC_LINK_LOST							0x0310
